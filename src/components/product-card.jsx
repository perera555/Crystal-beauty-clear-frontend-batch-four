    ...
    return(
        <Link to={"/overview/"+product.productId} className="w-[250px] m-4 h-[350px]  shadow-2xl">
            ...
            <div className="h-[110px] w-full flex justify-center flex-col px-4">
                ...
                <p className="text-lg text-pink-500">{product.price.toFixed(2)} <span className="line-through text-gray-400 text-sm">{product.price<product.labeledPrice&&product.labeledPrice.toFixed(2)}</span></p>
